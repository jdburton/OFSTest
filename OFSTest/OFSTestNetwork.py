...
#
    ...
    def updateCloudNodes(self,node_list=None, custom_kernel=False, kernel_git_location=None, kernel_git_branch=None,kernel_git_commit=None):
        ...
        self.updateNodes(cloud_nodes,custom_kernel,kernel_git_location,kernel_git_branch,kernel_git_commit)   
    ...
    def updateNodes(self,node_list=None, custom_kernel=False, kernel_git_location=None, kernel_git_branch=None, kernel_git_commit=None):
        if node_list is None:
            node_list = self.network_nodes
            
        # Run updateNode on the nodes simultaneously. 
        self.runSimultaneousCommands(node_list=node_list,node_function=OFSTestNode.OFSTestNode.updateNode,args=[custom_kernel,kernel_git_location,kernel_git_branch,kernel_git_commit])
        # Wait for reboot
